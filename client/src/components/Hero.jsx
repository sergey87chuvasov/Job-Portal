...
const Hero = () => {
    ...
    return <div className="container 2xl:px-20 mx-auto my-10">
        <div className="bg-gradient-to-r from-purple-800 to-purple-950 text-white py-16 text-center mx-2 rounded-xl">
            ...
            <div className="flex items-center justify-between bg-white rounded text-gray-600 max-w-xl pl-4 mx-4 sm:mx-auto">
                <div className="flex items-center">
                    <img className="h-4 sm:h-5" src={assets.search_icon} alt="icon pic" />
                    <input ref={titleRef} type="text" placeholder="Search for jobs" className="max-sm:text-xs p-2 rounded outline-none w-full"/>
                </div>
                <div className="flex items-center">
                    <img className="h-4 sm:h-5" src={assets.location_icon} alt="icon pic" />
        ...
        <div className="border border-gray-300 shadow-md mt-5 p-6 rounded-md flex">
            <div className="flex justify-center gap-10 lg:gap-16 flex-wrap">
                ...
                <img className="h-6" src={assets.microsoft_logo} alt="img pic" />
                <img className="h-6" src={assets.walmart_logo} alt="img pic" />
                <img className="h-6" src={assets.accenture_logo} alt="img pic" />
                <img className="h-6" src={assets.samsung_logo} alt="img pic" />
                <img className="h-6" src={assets.amazon_logo} alt="img pic" />
                <img className="h-6" src={assets.adobe_logo} alt="img pic" />
            </div>
        </div>
    </div>
  };
